...
plotWithError('nh', 'nhu1', list_nh, list_nh3, list_nh4, colors[1], colors[3], None, None)
# plotWithError()
# plotWithError()
# plotWithError()
plt.show()

plotWithError('ns', 'nsu1', list_ns, list_ns3, list_ns4, colors[1], colors[3], None, None)
# plotWithError()
# plotWithError()
# plotWithError()
plt.show()

plotWithError('sh', 'shu1', list_sh, list_sh3, list_sh4, colors[1], colors[3], None, None)
# plotWithError()
# plotWithError()
# plotWithError()
plt.show()

plotWithError('trp', 'trpu1', list_trp, list_trp3, list_trp4, colors[1], colors[3], None, None)
# plotWithError()
# plotWithError()
# plotWithError()
plt.show()
